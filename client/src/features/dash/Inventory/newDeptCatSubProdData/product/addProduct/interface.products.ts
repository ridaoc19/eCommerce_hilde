...
export interface InitialState {
  ...
  validationError: Omit<IProduct.Product, '_id' | 'subcategoryId' | 'specification' | 'images' | 'variants'> & { specification: string, images: string, specificationKey: string, specificationValue: string };
